...
FluidToItem.transform(<nuclearcraft:radaway>,dissipation, [<minecraft:reeds>,<nuclearcraft:glowing_mushroom>], false);
//结晶试剂
...
FluidToItem.transform(<mind:quartz_paint_ball>*2,crystal, [<appliedenergistics2:material:6>,<minecraft:bone_block>], false);
//杂酚油

...
Offering.addRecipe("botania_pool_0",<immersiveengineering:metal_device0:4>.withTag({tank: {FluidName: "water", Amount: 12000}}),2,<extrautils2:suncrystal>,<botania:pool:2>);

...
ResearchTable.builder("brushtower", mind)
  ...
  ResearchTable.builder("brushtower", mind)
  .setTitle("刷怪房")
  .setDescription("完成研究后会在玩家Z轴正方向生成刷怪房")
  .setIcons(<minecraft:rotten_flesh>)
  .addCondition(<minecraft:cobblestone>,256)
  .addCondition(<capsule:capsule:3>.withTag({sourceInventory: {}, size: 31, structureName: "config/capsule/prefabs/Mind-BrushTower", display: {color: 3949738}, label: "Mind-BrushTower"}), 1)
  .setRewardCommands("/testruin [brushtower_0] ~  ~-1 ~5")
  .setMaxCount(1)
  .build();
  ...
  ResearchTable.builder("materialball_processor", mind)
  .setTitle("物质球处理机")
  .setDescription("完成研究后会在玩家z轴正方向处生成物质球处理机")

...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "crafttweaker:plastic_processing"}),
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "crafttweaker:plastic_solidification"}),
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "crafttweaker:diamond_purifier"}),
